              ...
              <form class="form-horizontal" >
                ...
                <!-- modal content -->
                  <div class="modal-body" id = "report4body">
                      <div class="box-body">
                        <table class="table table-bordered table-striped" id = "report4Table">

                        </table>

                        <br><br>

                        <table class="table table-bordered table-striped" id = "report4TableBreakdown">
    ...
    $('#btnViewBusDocPay').click(function(){
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          $('.modal-title').html($('#btnBusDocPay-btn span').html());

          $('#report4Table').html('');
           $('#report4Table').append('<thead><th>PaymentID</th><th>PaymentDate</th><th>Paid Amount</th></thead>');
            ...
            $.each(data.datas, function(key1, val1){
               ...
               {
                $('#report4Table tbody').append('<tr align = "middle"><td>'+val1.PaymentID+'</td><td>'+val1.PaymentDate+'</td><td>'+val1.PaidAmount+'</td></tr>');
            ...
            $('#report4TableBreakdown tbody').append('<tr align = "middle"><td><strong>Total</strong></td><td>'+data.total[0].Total+'</td></tr>');
        }
      }).error(function(ts){
