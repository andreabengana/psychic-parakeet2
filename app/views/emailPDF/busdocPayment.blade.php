...
<h4 align="right" style="padding-top: -9%; font-size: 16px;">Document Request ID: {{$request[0]->BusRequestID}}</h4>
...
<h4 id = "total" style="padding-top: 10%; margin-left: 20%; z-index: 1;">Total Payment: {{$request -> DocumentFee}}</h4>
